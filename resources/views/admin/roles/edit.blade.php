    ...
    <div class="card shadow-sm rounded-4 border-0">
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            <h4 class="mb-0 fw-semibold text-secondary">
                <i class="bi bi-pencil-square me-2 text-warning"></i> Edit Role
            </h4>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.roles.update', $role->id) }}" method="POST" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="role_name" id="role_name" class="form-control rounded-3"
                        value="{{ $role->role_name }}" placeholder="e.g. Support Agent" required>
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" class="form-control rounded-3" rows="3"
                        placeholder="Optional: Describe this role’s purpose">{{ $role->description }}</textarea>
                </div>
